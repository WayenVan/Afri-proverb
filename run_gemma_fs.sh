...
accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir outputs/gemma3-4b-it-fs/gemma3-4b-it-gen-eng-literal-Somali \
...
accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir outputs/gemma3-4b-it-fs/gemma3-4b-it-gen-eng-fig-Somali \
  --model_name_or_path google/gemma-3-4b-it \
  --few_shot_num 1
#
accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir outputs/gemma3-4b-it-fs/gemma3-4b-it-gen-swa-literal-Somali \
  --model_name_or_path google/gemma-3-4b-it \
  --few_shot_num 1
...
accelerate launch --num_processes=1 --mixed_precision=bf16 \
  ...
  --output_dir outputs/gemma3-4b-it-fs/gemma3-4b-it-gen-swa-fig-Somali \
  --model_name_or_path google/gemma-3-4b-it \
  --few_shot_num 1
